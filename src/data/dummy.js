...
export const kanbanGrid = [
  { headerText: "انجام نشده", keyField: "Open", allowToggle: true },

  { headerText: "در حال انجام", keyField: "InProgress", allowToggle: true },

  {
    headerText: "در حال تست",
    keyField: "Testing",
    allowToggle: true,
    isExpanded: false,
  },

  { headerText: "اتمام یافته", keyField: "Close", allowToggle: true },
];
...
export const cartData = [
  {
    image: product5,
    name: "بستنی باتراسکاچ",
    category: "محصولات لبنی",
    price: "۲۵۰ دلار",
  },
  {
    image: product6,
    name: "گوجه فرنگی تازه سوپریم",
    category: "سبزیجات",
    price: "۴۵۰ دلار",
  },
  {
...
export const chatData = [
  {
    image: avatar2,
    message: "رومن به تیم پیوست!",
    desc: "به او تبریک بگویید",
    time: "9:08 صبح",
  },
  {
    image: avatar3,
    message: "پیام جدیدی دریافت شد",
    desc: "سلاما پیام جدیدی برای شما ارسال کرده است",
    time: "11:56 صبح",
  },
  {
    image: avatar4,
    message: "پرداخت جدیدی دریافت شد",
    desc: "درآمدهای خود را بررسی کنید",
    time: "4:39 صبح",
  },
  {
    image: avatar,
    message: "جولی وظایف را تکمیل کرد",
    desc: "وظایف جدیدی به او محول کنید",
    time: "1:12 صبح",
  },
];
...
export const customersData = [
  {
    CustomerID: 1001,
    CustomerName: "نیراو جوشی",
    CustomerEmail: "nirav@gmail.com",
    CustomerImage: avatar2,
    ProjectName: "هاستینگ پرس HTML",
    Status: "فعال",
    StatusBg: "#8BE78B",
    Weeks: "40",
    Budget: "۲.۴ هزار دلار",
    Location: "هند",
  },
  {
    CustomerID: 1002,
    CustomerName: "سونیل جوشی",
    CustomerEmail: "sunil@gmail.com",
    ProjectName: "الیت ادمین",
    Status: "فعال",
    CustomerImage: avatar3,
    StatusBg: "#8BE78B",
    Weeks: "11",
    Budget: "۳.۹ هزار دلار",
    Location: "هند",
  },
  {
    CustomerID: 1003,
    CustomerName: "اندرو مک‌دونلند",
    CustomerEmail: "andrew@gmail.com",
    ProjectName: "تم وردپرس ریل هومز",
    Status: "در انتظار",
    CustomerImage: avatar4,
    StatusBg: "#FEC90F",
    Weeks: "19",
    Budget: "۲۴.۵ هزار دلار",
    Location: "آمریکا",
  },
  {
    CustomerID: 1004,
    CustomerName: "کریستوفر جمیل",
    CustomerEmail: "jamil@gmail.com",
    ProjectName: "تم وردپرس مدیکال پرو",
    Status: "تکمیل شده",
    CustomerImage: avatar,
    StatusBg: "#8BE78B",
    Weeks: "34",
    Budget: "۱۶.۵ هزار دلار",
    Location: "آمریکا",
  },
  {
    CustomerID: 1005,
...
export const ordersData = [
  ...
  {
    OrderID: 345653,
    CustomerName: "کارسون دارین",
    TotalAmount: 56.34,
    OrderItems: "باتر اسکاج",
    Location: "دهلی",
    Status: "تکمیل شده",
    StatusBg: "#8BE78B",
  ...
  {
    OrderID: 390457,
    CustomerName: "فران پرز",
    TotalAmount: 93.31,
    OrderItems: "آب‌نبات گوچی",
    Location: "نیویورک",
    Status: "فعال",
    StatusBg: "#03C9D7",
  ...
  {
    OrderID: 748975,
    CustomerName: "میرون ویتولد",
    TotalAmount: 23.99,
    OrderItems: "محصولات بهداشتی اربولوژی",
    Location: "اسپانیا",
    Status: "رد شده",
    StatusBg: "قرمز",
  ...
  {
    OrderID: 94757,
    CustomerName: "کازین سیون",
    TotalAmount: 95.99,
    OrderItems: "مک‌بوک پرو",
    Location: "کانادا",
    Status: "در حال بررسی",
    StatusBg: "#FB9678",
  ...
  {
    OrderID: 944895,
    CustomerName: "جان دیوید",
    TotalAmount: 250.0,
    OrderItems: "آیفون 13 پرو",
    Location: "دبی",
    Status: "در حال بررسی",
    StatusBg: "#FB9678",
  ...
  {
    OrderID: 889324,
    CustomerName: "نودل جی",
    TotalAmount: 12.99,
    OrderItems: "روغن نارگیل",
    Location: "انگلیس",
    Status: "لغو شده",
    StatusBg: "#FF5C8E",
    ProductImage: product1,
  ...
  {
    OrderID: 874534,
    CustomerName: "ناتان بائر",
    TotalAmount: 25.0,
    OrderItems: "شمع خوشبو",
    Location: "آمریکا",
    Status: "در حال بررسی",
    StatusBg: "#FB9678",
    ProductImage: product4,
...
export const scheduleData = [
  {
    Id: 1,
    Subject: "انفجار ستاره بتل‌ژوس",
    Location: "مرکز فضایی ایالات متحده",
  ...
  {
    Id: 2,
    Subject: "گزارش سقوط هواپیمای ثوله",
    Location: "نیویورک",
  ...
  {
    Id: 7,
    Subject: "یخچال‌ها و برف‌پاره‌ها",
    Location: "هیمالیا",
  ...
  {
    Id: 13,
    Subject: "افسانه‌های کهکشان آندرومدا",
    Location: "مرکز فضایی ایالات متحده",
  ...
  {
    Id: 14,
    Subject: "بیگانگان در مقابل انسان‌ها",
    Location: "مرکز تحقیقاتی ایالات متحده",
  ...
  {
    Id: 15,
    Subject: "حقایق در مورد زنبورهای هویج",
    Location: "کالیفرنیا",
  ...
  {
    Id: 18,
    Subject: "کهکشان‌ها و سیارات فضایی",
    Location: "مرکز فضایی ایالات متحده",
...
export const pieChartData = [
  { x: "کارگر", y: 18, text: "18%" },
  { x: "حقوقی", y: 8, text: "8%" },
  { x: "تولید", y: 15, text: "15%" },
  { x: "مجوز", y: 11, text: "11%" },
  { x: "تسهیلات", y: 18, text: "18%" },
  { x: "مالیات", y: 14, text: "14%" },
  { x: "بیمه", y: 16, text: "16%" },
];
...
export const kanbanData = [
  {
    ...
    Title: "وظیفه - 29001",
    Status: "Open",
    Summary: "نیازمندی‌های جدید جمع‌آوری‌شده از مشتری را تجزیه و تحلیل کنید.",
    Type: "داستان",
    Priority: "پایین",
    Tags: "تجزیه و تحلیل,مشتری",
    Estimate: 3.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29002",
    Status: "InProgress",
    Summary: "عملکرد برنامه را بهبود دهید",
    Type: "Improvement",
    Priority: "عادی",
    Tags: "بهبود",
    Estimate: 6,
  ...
  },
  {
    ...
    Title: "وظیفه - 29003",
    Status: "Open",
    Summary: "یک جلسه وب با مشتری برای دریافت نیازمندی‌های جدید ترتیب دهید.",
    Type: "Others",
    Priority: "بحرانی",
    Tags: "جلسه",
    Estimate: 5.5,
    Assignee: "جانت لیورلینگ",
    RankId: 2,
    Color: "#1F88E5",
  ...
  },
  {
    ...
    Title: "وظیفه - 29004",
    Status: "InProgress",
    Summary: "مشکلات گزارش‌شده در مرورگر IE را برطرف کنید.",
    Type: "Bug",
    Priority: "بحرانی",
    Tags: "IE",
    Estimate: 2.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29007",
    Status: "Validate",
    Summary: "نیازمندی‌های جدید را تأیید کنید",
    Type: "Improvement",
    Priority: "پایین",
    Tags: "تأیید",
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29009",
    Status: "Review",
    Summary: "مشکلات گزارش‌شده در مرورگر Safari را برطرف کنید.",
    Type: "Bug",
    Priority: "بحرانی",
    Tags: "رفع, Safari",
    Estimate: 1.5,
    Assignee: "نانسی داولیو",
    RankId: 2,
    Color: "#E64A19",
  ...
  },
  {
    ...
    Title: "وظیفه - 29010",
    Status: "Close",
    Summary: "عملکرد برنامه را در مرورگر IE تست کنید.",
    Type: "Story",
    Priority: "پایین",
    Tags: "بررسی, IE",
    Estimate: 5.5,
    Assignee: "مارگارت همیلت",
    RankId: 3,
    Color: "#02897B",
  ...
  },
  {
    ...
    Title: "وظیفه - 29011",
    Status: "Validate",
    Summary: "مشکلات گزارش‌شده توسط مشتری را تأیید کنید.",
    Type: "Story",
    Priority: "بالا",
    Tags: "تأیید, رفع",
    Estimate: 1,
  ...
  },
  {
    ...
    Title: "وظیفه - 29015",
    Status: "Open",
    Summary: "داده‌های بازیابی‌شده از سرور را در کنترل گرید نمایش دهید.",
    Type: "Story",
    Priority: "بالا",
    Tags: "پایگاه داده, SQL",
    Estimate: 5.5,
    Assignee: "مارگارت همیلت",
    RankId: 4,
    Color: "#02897B",
  ...
  },
  {
    ...
    Title: "وظیفه - 29016",
    Status: "InProgress",
    Summary: "خطای SQL برای باز کردن پایگاه داده پیش‌فرض کاربر را برطرف کنید.",
    Type: "Bug",
    Priority: "بحرانی",
    Tags: "پایگاه داده, Sql2008",
    Estimate: 2.5,
    Assignee: "جانت لیورلینگ",
    RankId: 4,
    Color: "#E64A19",
  ...
  },
  {
    ...
    Title: "وظیفه - 29017",
    Status: "Review",
    Summary: "مشکلات گزارش‌شده در داده‌بندی را برطرف کنید.",
    Type: "Story",
    Priority: "عادی",
    Tags: "داده‌بندی",
    Estimate: "3.5",
  ...
  },
  {
    ...
    Title: "وظیفه - 29018",
    Status: "Close",
    Summary: "اتصال به سرور SQL 2008 را تجزیه و تحلیل کنید.",
    Type: "Story",
    Priority: "بحرانی",
    Tags: "گرید, SQL",
    Estimate: 2,
  ...
  },
  {
    ...
    Title: "وظیفه - 29019",
    Status: "Validate",
    Summary: "مشکلات داده‌بندی را تأیید کنید.",
    Type: "Story",
    Priority: "پایین",
    Tags: "تأیید",
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29020",
    Status: "Close",
    Summary: "کنترل گرید را تجزیه و تحلیل کنید.",
    Type: "Story",
    Priority: "بالا",
    Tags: "تجزیه و تحلیل",
    Estimate: 2.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29021",
    Status: "Close",
    Summary: "پروسیجر ذخیره‌سازی برای داده‌بندی اولیه گرید.",
    Type: "Others",
    Priority: "بحرانی",
    Tags: "داده‌بندی",
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29022",
    Status: "Close",
    Summary: "پروسیجرهای ذخیره‌سازی را تجزیه و تحلیل کنید.",
    Type: "Story",
    Priority: "بحرانی",
    Tags: "پروسیجرها",
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29023",
    Status: "Validate",
    Summary: "مشکلات ویرایش را تأیید کنید.",
    Type: "Story",
    Priority: "بحرانی",
    Tags: "ویرایش",
    Estimate: 1,
  ...
  },
  {
    ...
    Title: "وظیفه - 29024",
    Status: "Review",
    Summary: "عملکرد ویرایش را تست کنید.",
    Type: "Story",
    Priority: "عادی",
    Tags: "ویرایش, تست",
    Estimate: 0.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29025",
    Status: "Open",
    Summary: "عملکرد ویرایش را بهبود دهید.",
    Type: "Improvement",
    Priority: "پایین",
    Tags: "ویرایش",
    Estimate: 3.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29026",
    Status: "InProgress",
    Summary: "عملکرد عملکرد ویرایش را بهبود دهید.",
    Type: "Epic",
    Priority: "بالا",
    Tags: "عملکرد",
    Estimate: 6,
  ...
  },
  {
    ...
    Title: "وظیفه - 29027",
    Status: "Open",
    Summary: "جلسه وب با مشتری برای نمایش دموی ویرایش ترتیب دهید.",
    Type: "Others",
    Priority: "بالا",
    Tags: "جلسه, ویرایش",
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: "وظیفه - 29029",
    Status: "Review",
    Summary: "مشکلات ویرایش گزارش‌شده توسط مشتری را برطرف کنید.",
    Type: "Bug",
    Priority: "پایین",
    Tags: "ویرایش, رفع",
    Estimate: "3.5",
...
export const PyramidData = [
  { x: "شیرینی‌های شیرین", y: 120, text: "120 کالری" },
  { x: "شیر، ماست، پنیر", y: 435, text: "435 کالری" },
  { x: "سبزیجات", y: 470, text: "470 کالری" },
  { x: "گوشت، مرغ، ماهی", y: 475, text: "475 کالری" },
  { x: "میوه‌ها", y: 520, text: "520 کالری" },
  { x: "نان، برنج، پاستا", y: 930, text: "930 کالری" },
];
